...
namespace FileMonitorWorkerService.Utility
{
    public static class FileHelper
    {
        ...
        public static Task MoveFileToArchiveAsync(string sourceFile, string archiveDirectory)
        {
            try
            {
        ...
        public static Task MoveFileToArchiveAsync(string sourceFile, string archiveDirectory, string baseIncomingPath)
        {
            try
            {
                if (!Directory.Exists(archiveDirectory))
