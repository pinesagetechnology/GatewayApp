...
Cmnd_Alias FILEMONITOR_FILE_OPS = /bin/mkdir, /bin/rm, /bin/rmdir, /bin/mv, /bin/cp, /bin/chmod, /bin/chown, /bin/chgrp, /bin/touch
Cmnd_Alias FILEMONITOR_SCRIPTS = /bin/bash $INSTALL_PATH/scripts/*, /usr/bin/bash $INSTALL_PATH/scripts/*, /bin/bash $INSTALL_PATH/scripts/*.sh, /usr/bin/bash $INSTALL_PATH/scripts/*.sh
Cmnd_Alias FILEMONITOR_SERVICE = /bin/systemctl restart $SERVICE_NAME, /bin/systemctl status $SERVICE_NAME

$SERVICE_USER ALL=(ALL) NOPASSWD: FILEMONITOR_FILE_OPS
$SERVICE_USER ALL=(ALL) NOPASSWD: FILEMONITOR_SCRIPTS
$SERVICE_USER ALL=(ALL) NOPASSWD: FILEMONITOR_SERVICE
EOF
